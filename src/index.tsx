...
const Q = [
  ...
  {"id": "43", "img": "vi/cau43.png", "question": "Hãy nghe âm thanh và đoán tên nhạc cụ?", "choices": [{"icon": "1️⃣", "label": "Xắc xô"}, {"icon": "2️⃣", "label": "Trống"}, {"icon": "3️⃣", "label": "Đàn ghi ta"}], "correct": 2, "speak": "Hãy nghe âm thanh và đoán tên nhạc cụ?  Một: Xắc xô   Hai: Trống  Ba: Đàn ghi ta", "media": "music_43", "emoji": "🎶"},
